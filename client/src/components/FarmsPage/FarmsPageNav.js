          ...
          <MDBContainer fluid>
            ...
            <MDBCollapse navbar show={showNav}>
              <MDBNavbarNav>
                ...
                <MDBNavbarLink active={currentPage === `${url}/historicgraph`} href={`${url}/historicgraph`}>
                  Historic Climate Graphs
                </MDBNavbarLink>
                <MDBNavbarLink active={currentPage === `${url}/futuregraph`} href={`${url}/futuregraph`}>
                  Future Climate Graphs
                </MDBNavbarLink>
                <MDBNavbarLink active={currentPage === `${url}/pictures`} href={`${url}/pictures`}>
                  Farm Pictures
                </MDBNavbarLink>
                <MDBNavbarLink href={`${homePage}`}>
                  Back to Map
                </MDBNavbarLink>
              </MDBNavbarNav>
            </MDBCollapse>
